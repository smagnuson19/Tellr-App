...
class ParentViewAnalytics extends Component {
  constructor(props) {
    super(props);
    // const { navigation } = this.props;
    // const childEmail = navigation.getParam('childInfo');
    const { navigation } = this.props;
  ...
  componentWillMount() {
    ...
    Object.keys(this.state.childAccount[0].retNeg).forEach((key1) => {
      alldat.push({ value: this.state.childAccount[0].retNeg[key1] });
    });
    Object.keys(this.state.childAccount[0].retPos).forEach((key2) => {
      alldat.push({ value: this.state.childAccount[0].retPos[key2] });
    });
    datDict[0] = alldat;

    const alldat1 = [];
    Object.keys(this.state.childAccount[1].retNeg).forEach((key3) => {
      alldat1.push({ value: this.state.childAccount[1].retNeg[key3] });
    });
    Object.keys(this.state.childAccount[1].retPos).forEach((key4) => {
      alldat1.push({ value: this.state.childAccount[1].retPos[key4] });
    });
    datDict[1] = alldat1;

    const alldat2 = [];
    Object.keys(this.state.childAccount[2].retNeg).forEach((key5) => {
      alldat2.push({ value: this.state.childAccount[2].retNeg[key5] });
    });
    Object.keys(this.state.childAccount[2].retPos).forEach((key6) => {
      alldat2.push({ value: this.state.childAccount[2].retPos[key6] });
    });
    datDict[2] = alldat2;
    ...
    const barzero = [
      {
        data: valMaker(this.state.childAccount[0].retPos),
        svg: {
          fill: 'rgb(24, 128, 24)',
        },
      },
      {
        data: valMaker(this.state.childAccount[0].retNeg),
      },
    ];
    ...
    const barone = [
      {
        data: valMaker(this.state.childAccount[1].retPos),
        svg: {
          fill: 'rgb(24, 128, 24)',
        },
      },
      {
        data: valMaker(this.state.childAccount[1].retNeg),
      },
    ];
    ...
    const bartwo = [
      {
        data: valMaker(this.state.childAccount[2].retPos),
        svg: {
          fill: 'rgb(24, 128, 24)',
        },
      },
      {
        data: valMaker(this.state.childAccount[2].retNeg),
      },
    ];
    ...
    const max1 = this.state.childAccount[0].max;
    const max2 = this.state.childAccount[1].max;
    const max3 = this.state.childAccount[2].max;
    const maxDict = {
      0: max1,
      1: max2,
      2: max3,
  ...
  renderChart() {
    ...
    const balHist = [];
    Object.keys(this.state.childAccount[this.state.filter].balanceGraph).forEach((key) => {
      balHist.push({ value: this.state.childAccount[this.state.filter].balanceGraph[key][0], index: new Date(`${this.state.childAccount[this.state.filter].balanceGraph[key][1]}`) });
    });
    const contentInset = {
      ...
      >
        <View style={{ flex: 1, paddingLeft: 10 }}>
          ...
          <ProgressCircle
            ...
            progress={parseFloat(this.state.childAccount[this.state.filter].avgGoal) / 50}
        ...
        >
          ...
          <ProgressCircle
            style={{ height: 158, paddingTop: 5 }}
            progress={parseFloat(this.state.childAccount[this.state.filter].avgTask) / 50}
    ...
    return (
      ...
      >
        <View style={{ flex: 1, paddingLeft: 10 }}>
          ...
          <ProgressCircle
            style={{ height: 158, paddingTop: 5 }}
            progress={parseFloat(this.state.childAccount[this.state.filter].rate) / 50}
        ...
        >
          ...
          <ProgressCircle
            style={{ height: 158, paddingTop: 5 }}
            progress={parseFloat(this.state.childAccount[this.state.filter].net) / 250}
        ...
        <LinearGradient colors={[themeColors.linearGradientTop[this.props.mode], themeColors.linearGradientBottom[this.props.mode]]} style={Style.gradient}>
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              >
                {`$${this.state.childAccount[this.state.filter].avgTask}`}
              </Text>
              <Text
                style={{
                  position: 'absolute',
              ...
              >
                {`$${this.state.childAccount[this.state.filter].avgGoal}`}
              </Text>
              ...
              >
                {`$${this.state.childAccount[this.state.filter].rate}`}
              </Text>
              <Text
                style={{
                  position: 'absolute',
              ...
              >
                {`$${this.state.childAccount[this.state.filter].net}`}
              </Text>
              {this.renderBottom()}
              {this.render2Bottom()}
              <Text style={pageStyle.subSectionText}>
...
export default connect(mapStateToProps, { fetchAllStats })(ParentViewAnalytics);
